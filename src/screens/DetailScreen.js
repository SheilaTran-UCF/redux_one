...
const DetailScreen = props => {
  ...
  const getYoutubeKey = movieId => {
    fetch(
      `https://api.themoviedb.org/3/movie/${movieId}/videos?api_key=c0d41ba4fd2c7ba8c6252c0e08ea89b5&language=en-US`,
    )
      .then(res => res.json())
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView>
        ...
        <View style={styles.desContainer}>
          ...
          <Text style={{paddingTop: 10, color: 'white', fontSize: 15}}>
            {movie.overview}
          </Text>
          <Button
            style={{
